...
describe("client event bookmarks and subscription lifetime", () => {
  ...
  it.each([
    { protocolVersion: 2, event: { seq: 1, at: 0, type: "RuntimeSuspended" } },
    { protocolVersion: 1, event: { seq: 1, at: 0, type: "unknown-event" } },
    { protocolVersion: 1, event: { seq: 2, at: 0, type: "RuntimeSuspended" } },
