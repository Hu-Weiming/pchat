...
更新日期：2026-09-18。当前阶段：Windows 0.1.0 可操作验收版已安装，正式页面、SQLite、供应商接口、原生网络/凭证与知识库配置已接通；安装页查询/订阅/退出清理通过，真实账户与内容验收等待用户准备 Key 和资料。新增确认的 DeepSeek 选路 → 千帆纯原典检索 → DeepSeek 最终回答工作流尚未编码验收。
