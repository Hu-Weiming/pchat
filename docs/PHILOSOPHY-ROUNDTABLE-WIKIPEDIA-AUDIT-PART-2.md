...
```mermaid
flowchart LR
  StructuralLinguistics["结构语言学 / 符号学"] --> Saussure["索绪尔<br/>《普通语言学教程》〔遗作；学生据讲义编纂〕"]
  Structuralism["结构主义 / 结构人类学"] --> LeviStrauss["列维-斯特劳斯<br/>《亲属关系的基本结构》<br/>《结构人类学》〔论文集〕"]
  PostStructuralism["后结构主义"] --> Foucault["福柯<br/>《规训与惩罚》<br/>《性史》〔第4卷遗作〕"]
  Boasian["博厄斯学派 / 人类语言学"] --> Sapir["萨丕尔<br/>《语言：言语研究导论》"]
  Generative["分析哲学（语言与心灵）/ 生成语法"] --> Chomsky["乔姆斯基<br/>《句法结构》<br/>《笛卡尔语言学》〔理性主义归类有争议〕"]
  AnalyticLogicism["分析哲学 / 逻辑主义"] --> Frege["弗雷格<br/>《概念文字》<br/>《算术基础》"]
  AnalyticLogicism --> Russell["罗素<br/>《数学原理 Principia Mathematica》〔与怀特海合著〕<br/>《哲学问题》"]
  EarlyAnalytic["青年维特根斯坦：逻辑原子论 / 理想语言"] --> EarlyW["维特根斯坦[青年]<br/>《逻辑哲学论》"]
  OrdinaryLanguage["晚期维特根斯坦：日常语言 / 治疗式方法"] --> LateW["维特根斯坦[晚年]<br/>《哲学研究》〔遗作；编辑整理〕"]
  ExistentialFeminism["存在主义 / 女性主义存在主义"] --> Beauvoir["波伏娃<br/>《模棱两可的伦理学》<br/>《第二性》"]
```
